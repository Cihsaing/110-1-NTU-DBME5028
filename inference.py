...
from utils import val_f1, grad_cam
...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_mode", type=str, default='test', help="test/val/semi/visualize")
    ...
    elif opt.test_mode == 'visualize': # Grad cam visualization
